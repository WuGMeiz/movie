...
<html>
  ...
  <script type="text/javascript">
     $(function(){
      ...
      function handlePaginationClick(new_page_index, pagination_container){
         $("#mainForm").attr("action", "<%=path%>/findAllVip.do?currentPage=" + (new_page_index+1));
		  $("#mainForm").submit();
		   	 return false;
      };
  </script>
  ...
  <div class="panel admin-panel">
    ...
    <form method="post" action="<%=path%>/findAllVip.do"  name="form1" id="mainForm">
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li>
          ...
          <input type="submit" class="tabSub" value="搜索" /></li>
          <li>&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</li>
          <li><a class="button border-main icon-plus-square-o" href="<%=path %>/addvipbefore.do">添加管理员</a> </li>
      </ul>
    </div>
    </form>
    ...
    <table class="table table-hover text-center" height="45px">
      ...
      <c:forEach items="${page.content}" var="u" varStatus="b">
      	<tr>
	        ...
	        <td>${u.vcard }</td>
	        <td>${u.vstate }</td>
	       	<td><div class="button-group"> <a class="button border-main" href="<%=path %>/updvipbefore.do?vid=${u.vid }"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<%=path%>/delViper.do?vid=${u.vid}" onclick="return confirm('确认删除？')"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
      </c:forEach>
  		<tr>
        <td colspan="9">
